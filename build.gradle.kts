...
// already exist by the time configuration reaches the android target.
...
kotlin {
    ...
    val xcf = XCFramework("Log")

    macosArm64 {
        binaries.framework { baseName = "Log"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Log"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Log"
        flattenPackage = "io.github.kotlinmania.log"
    }

    android {
        namespace = "io.github.kotlinmania.log"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "log-kotlin", version.toString())
    ...
    pom {
        ...
        scm {
            url.set("https://github.com/KotlinMania/log-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/log-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/log-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.log.codeql
