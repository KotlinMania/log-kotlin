...
This file is the quick-reference operating contract for log-kotlin. The longer
...
log-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`log`](https://crates.io/crates/log). Upstream Rust is the behavioral oracle while the
